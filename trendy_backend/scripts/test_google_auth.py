...
def test_token_verification():
    ...
    with patch.dict(os.environ, {'GOOGLE_CLIENT_ID': 'test-client-id'}):
        ...
        with patch('google.oauth2.id_token.verify_oauth2_token') as mock_verify:
            ...
            try:
                result = auth.verify_google_token("fake-token")
        ...
        with patch('google.oauth2.id_token.verify_oauth2_token') as mock_verify:
            ...
            try:
                result = auth.verify_google_token("invalid-token")
...
def test_handle_google_login():
    ...
    with patch.dict(os.environ, {'GOOGLE_CLIENT_ID': 'test-client-id'}):
        ...
        with patch.object(auth, 'verify_google_token') as mock_verify:
            ...
            try:
                result = auth.handle_google_login(mock_db, "fake-token")
